...
const heroes = [
    { name: 'Ascent', img: 'Assets/HeroPick/Ascent.webp' },
    { name: 'Split', img: 'Assets/HeroPick/Split.webp' },
    { name: 'Haven', img: 'Assets/HeroPick/Haven.webp' },
    { name: 'Bind', img: 'Assets/HeroPick/Bind.webp' },
    { name: 'Icebox', img: 'Assets/HeroPick/Icebox.webp' },
    { name: 'Breeze', img: 'Assets/HeroPick/Breeze.webp' },
    { name: 'Fracture', img: 'Assets/HeroPick/Fracture.webp' },
    { name: 'Fracture', img: 'Assets/HeroPick/Fracture.webp' },
    { name: 'Pearl', img: 'Assets/HeroPick/Pearl.webp' },
    { name: 'Lotus', img: 'Assets/HeroPick/Lotus.webp' },
    { name: 'Sunset', img: 'Assets/HeroPick/Sunset.webp' },
...
// Fungsi untuk menampilkan gambar ketika item dipilih
function displayImage() {
    // Dapatkan elemen tempat gambar akan ditampilkan
    const imageDisplay = document.getElementById("image-display-2");
    ...
    // Masukkan gambar ke dalam div image-display-2
    imageDisplay.appendChild(img);
}

// Panggil fungsi displayImage untuk menampilkan gambar saat halaman dimuat atau saat item dipilih
displayImage();
...
// Fungsi untuk menampilkan nama turnamen
function updateTournamentName() {
    const tournamentInput = document.getElementById("tournamentnamemid");
    const tournamentOutput = document.getElementById("tournamentnameOutput");

    // Ambil nilai dari input dan masukkan ke dalam output
    tournamentOutput.textContent = tournamentInput.value;
}

// Tambahkan event listener ke input untuk memanggil updateTournamentName setiap kali ada perubahan
document.getElementById("tournamentnamemid").addEventListener("input", updateTournamentName);
